...
- ⚠️ Vercel과 Render는 서로 다른 eTLD+1 → cross-origin cookie 이슈.
  운영 진입 전 커스텀 도메인 확보 필수 (`tech-debt-tracker.md`).
...
- ORM: **Spring Data JPA / Hibernate** (스키마는 Flyway 관리, `ddl-auto: validate`)
